...
summary(rfit(Midterm2 ~ 
               ...
               jadud_hw_06_c + jadud_hw_07_c + jadud_hw_08_c, data = jadud_df, scores = bentscores3))
...
summary(rfit(Midterm2 ~ 
               ...
               jadud_hw_06_r + jadud_hw_07_r + jadud_hw_08_r, data = jadud_df, scores = bentscores3))
```
...
summary(rfit(Midterm1 ~ RED_hw_03_c + RED_hw_04_c, data = RED_df, scores = bentscores3))

# predict midterm1 with both compiler and runtime RED measures
summary(rfit(Midterm1 ~ RED_hw_03_c + RED_hw_04_c + RED_hw_03_r + RED_hw_04_r, data = RED_df, scores = bentscores3))
...
summary(rfit(Midterm2 ~
                     RED_hw_03_c + RED_hw_04_c + RED_hw_05_c +
                             RED_hw_06_c + RED_hw_07_c + RED_hw_08_c, data = RED_df, scores = bentscores3))
...
summary(rfit(Midterm2 ~
                     RED_hw_03_c + RED_hw_04_c + RED_hw_05_c +
                             ...
                             RED_hw_06_r + RED_hw_07_r + RED_hw_08_r, data = RED_df, scores = bentscores3))
```
